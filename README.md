...
**쓰고 싶으시면 [이메일](mailto:goodpjw2008@gmail.com)로 알려 주세요 — 대부분 흔쾌히 허락해 드립니다.** 막으려고 두는 조건이 아니라, 무분별한 복사를 막으려는 것입니다. 수업 · 연구 · 발표에 쓰시겠다면 더욱 반갑습니다.

읽어 보시는 것과 [서비스 주소](https://safelevelup.vercel.app)에서 직접 연습해 보시는 것은 자유이고, 그 밖의 사용만 미리 허락을 받으시면 됩니다 — 영리든 비영리든 같습니다. (자세한 조건은 [LICENSE](LICENSE))

| 자산 | 라이선스 |
|---|---|
| **직접 만든 것 전부** — 코드 · 그림 · 글 | [**모든 권리 보유 — 사용 시 허락**](LICENSE) |
