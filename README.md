...
* 서비스 주소 : https://safedrive.vercel.app
* 포트폴리오 : https://safedrive.vercel.app/AI_safeturn_portfolio.html

<a href="https://safedrive.vercel.app/AI_safeturn_portfolio.html"><img src="docs/portfolio-slideshow.webp" alt="AI 안전운전 교실 포트폴리오 — 장표 22장이 저절로 넘어갑니다" width="880"></a>

---

※ 라이선스 — © 2026 goodpjw2008 · **모든 권리 보유**

읽어 보시는 것과 [서비스 주소](https://safedrive.vercel.app)에서 직접 연습해 보시는 것은 자유입니다. 그 밖의 사용(복사 · 수정 · 재배포 · 다른 곳에 싣기)은 영리 · 비영리를 가리지 않고 **먼저 허락**을 받아 주세요.

막으려고 두는 조건이 아닙니다. 다만 무분별한 복제가 흔한 일이 되어, 형식적이더라도 **허락을 구하는 절차**는 필요하다고 생각합니다. 고등학생이 혼자 만든 것이라 어디에 어떻게 쓰이는지 정도는 알고 있고 싶습니다. **사용은 대부분 흔쾌히 허락 드립니다 — 무엇에 쓰실지만 알려 주세요.** 수업이나 연구에 쓰시겠다면 더욱 반갑습니다. (goodpjw2008@gmail.com · 자세한 조건은 [LICENSE](LICENSE))
