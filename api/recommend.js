/**
 * 배포용 `/api/recommend` — AI 코스 추천 (Vercel).
 *
 * 알맹이는 개발 서버 · Cloudflare(functions/api/recommend.js)와 **같은** `handleRecommend` 이고, 껍데기는
...
export default vercelHandler('recommend', handleRecommend);
