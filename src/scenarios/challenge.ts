 ...
 * 2. **도움** — 주행 중 AI 어우참 말풍선 · 보행자 느낌표 · 정지 구역 노면 표시 (`hints`)
...
export interface ChallengeRule {
  ...
  reach: number;
  /**
   * **주행 중 도움을 얼마나 주는가.** 코스를 어렵게 골라도 AI 어우참이 "정지선까지 5m · 보행자가 건너려 합니다"
   ...
   * 보통(1)이 새 맵 무위반 55판, 쉬움(0.5)은 그 절반, 어려움(1.5)은 한 배 반이다.
   */
  xpScale: number;
...
export const CHALLENGES: readonly ChallengeRule[] = [
  ...
  },
  {
    id: 3,
    name: '보통',
    desc: '조건이 겹친 코스 · AI 어우참은 할 일만 · 위반하면 경험치 −20',
    complexity: 0.45,
    cap: 12,
    skipEmpty: true,
    reach: 0,
