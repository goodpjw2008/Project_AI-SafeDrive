...
/** 방금 끝난 판으로 우회전 마스터가 됐는가 — 결과 화면이 한 번 축하하고 끈다 */
...
function renderMenu(): void {
  stopAutoNext();
  stopAiDriving();
  // 첫 화면으로 돌아오면 맵 체험도 끝난다 — 다음에 누르는 '이어서 운행' 이 체험으로 이어지지 않게
  mapTrial = false;
 ...
 * 드러나지 않았다. 사용자가 짚었다: "레벨 10 이후에는 마스터를 하며 게임의 엔딩이 되는 거야. AI 우린이가 normal.webp
...
/**
 * 시범 코스 하나가 끝났다 — 결과 화면을 잠깐 보여 주고 다음 코스로, 마지막이면 첫 화면으로.
 *
